...
export default function Login1() {
    ...
    const submitHandler= async()=>{
        try{
          ...
          setLoading(false);
          const data=await axios.post("http://192.168.1.61:8081/api/v1/auth/login",{email,password});
        ...
        //   await AsyncStorage.setItem('@auth', JSON.stringify(token));
          console.log("registeration is successful",{email,password})
            ...
            <ImageBackground source={require('./../../assets/hmlo.jpg')} style={styles.backgroundImage}>
                <View style={styles.container}>
                    ...
                    <TouchableOpacity style={styles.button}
                        onPress=
                        {() => {
                            submitHandler(),navigation.navigate('MainTabs')
                        }}
                    >
