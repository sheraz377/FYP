...
//               'http://192.168.1.10:8080/api/v1/auth/getUserOrders',
//               {}, // Request body if any
//               {
//                 headers: {
//                   'authorization': token,
...
//               console.log("orders:", userSurplus);
//               setData(userSurplus);
//           } catch (error) {
    ...
    const navigation = useNavigation();
        ...
        const getUserData=async()=>{
            try {
                ...
                const response = await axios.post(
                  'http://192.168.1.15:8080/api/v1/auth/getUserData',
                  {}, // Request body if any
                  {
                    headers: {
                      'authorization': token,
        ...
        try {
            const token = await AsyncStorage.getItem('token');
                ...
                const response = await axios.put(
                  'http://192.168.1.10:8080/api/v1/auth/about',
