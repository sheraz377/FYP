  ...
  return (
    <GestureHandlerRootView style={{ flex: 1 }}>
      <OverlayProvider  >
        ...
        {!token&&<Stack.Screen name="Activation" component={Activation} options={{ headerShown: false }}/>}
        {!token&&<Stack.Screen name="Login1" component={Login1} options={{ headerShown: false }}/>}
